...
# Cost-saving phase: only SQS (+ VPC) is active - outputs for disabled
# modules (EKS, RDS, DynamoDB, ElastiCache, ECR, IRSA) are commented out
# below. Uncomment together with their modules in main.tf.
