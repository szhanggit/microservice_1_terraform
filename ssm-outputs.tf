...
# Cost-saving phase: only SQS (+ VPC) is active - parameters/secrets for
# disabled modules (EKS, ECR, DynamoDB, ElastiCache, RDS, IRSA) are commented
# out below. Uncomment together with their modules in main.tf.
